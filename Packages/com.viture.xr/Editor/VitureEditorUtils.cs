...
namespace Viture.XR.Editor
{
    internal static class VitureEditorUtils
    {
        ...
        internal const string k_SDKSampleRGBCameraDemo = "RGB Camera Demo";
        ...
        internal const string k_VitureRGBCameraPrefabName = "RGB Camera API";
        #endregion
        ...
        #region Graphics - RGBCamera
        internal const string k_OESBlitShaderName = "Hidden/VitureXR/OESBlit";

        /// <summary>
        /// Ensures OESBlit shader is in Always Included Shaders so it is not stripped in URP/build.
        /// Required for RGBCamera RawImage display on device.
        /// </summary>
        internal static void EnsureOESBlitInAlwaysIncludedShaders()
        {
            var oesBlit = Shader.Find(k_OESBlitShaderName);
            if (oesBlit == null)
                return;
            ...
            for (int i = 0; i < prop.arraySize; i++)
            {
                ...
                if (elem.objectReferenceValue == oesBlit)
                    return;
            }

            prop.arraySize++;
            prop.GetArrayElementAtIndex(prop.arraySize - 1).objectReferenceValue = oesBlit;
