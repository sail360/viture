...
namespace Viture.XR.Editor
{
    ...
    public class VitureSettingsEditor : UnityEditor.Editor
    {
        ...
        private const string k_HandAimSensitivityTooltip =
            "Controls the sensitivity of the hand aim ray. Low uses arm direction only for a stable ray. " +
            "High blends arm and wrist direction for more responsive aiming. Only takes effect in 6DoF mode. " +
            "Can be changed at runtime via VitureXR.HandTracking.aimSensitivity.";
        ...
        public override void OnInspectorGUI()
        {
            ...
            var handAimSensitivityProp = serializedObject.FindProperty("m_HandAimSensitivity");
            EditorGUILayout.PropertyField(handAimSensitivityProp, new GUIContent("Hand Aim Sensitivity", k_HandAimSensitivityTooltip));
            EditorGUILayout.Space(5);
            ...
            if (m_PermissionsFoldout)
            {
                ...
                //DrawPermission("m_RecordAudioPermission", "Record Audio", "android.permission.RECORD_AUDIO");
